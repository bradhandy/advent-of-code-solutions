package com.dbjgb.advent.sixteen.puzzle.three;
...
public class Solution {
  ...
  private static void findPossibleValidTrianglesByRow() throws Exception {
    try (BufferedReader inputReader = Utility.openInputFile("sixteen/puzzle/three/input.txt")) {
  ...
  private static void findPossibleTrianglesByColumn() throws Exception {
    try (LineNumberReader inputReader =
        new LineNumberReader(
            new InputStreamReader(Utility.openInputStream("sixteen/puzzle/three/input.txt")))) {
