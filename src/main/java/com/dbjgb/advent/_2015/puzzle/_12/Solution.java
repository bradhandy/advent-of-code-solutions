package com.dbjgb.advent._2015.puzzle._12;
...
public class Solution {
  ...
  private static void printSumOfAllNumberValues() throws IOException {
    ...
    String line;
    try (BufferedReader inputReader = Utility.openInputFile("_2015/puzzle/_12/input.txt")) {
  ...
  private static void printSumOfAllNonRedNumberValues() throws Exception {
    ...
    Map<String, Object> data =
        objectMapper.readValue(
            objectMapper.createParser(Utility.openInputStream("_2015/puzzle/_12/input.txt")),
            GENERIC_OBJECT_TYPE);
